...
do
    ...
    do
        ...
        do
            python main.py --enable_u=1 --dataset=${dataset} --train_dir=default --hidden_units=50 --u_hidden_units=50 --maxlen=${maxlen} --dropout_rate=${dropout}   --model=${model} --num_epochs=${epoch} > logs_ipw/${dataset}_${model}_base_$i.log  2>&1 &

            python main.py --enable_u=1 --dataset=${dataset} --train_dir=default --hidden_units=50 --u_hidden_units=50 --maxlen=${maxlen} --dropout_rate=${dropout} --model=${model} --num_epochs=${epoch} --c0=${c0} --disentangle=False --debias=True --additive_bias=False  > logs_ipw/${dataset}_${model}_macr_$i.log  2>&1 &

            python main.py --enable_u=1 --dataset=${dataset} --train_dir=default --hidden_units=50 --u_hidden_units=50 --maxlen=${maxlen} --dropout_rate=${dropout} --model=${model} --num_epochs=${epoch} --c0=${c0} --disentangle=True --debias=True --additive_bias=False --pop_loss_w=0.02 --dynamic_pop_int_weight=False --pop_match_loss_w=0.0 --int_match_loss_w=0.0 --pop_match_tower=True > logs_ipw/${dataset}_${model}_dist_base_$i.log 2>&1 &
            ...
            wait_function
            python main.py --enable_u=1 --dataset=${dataset} --train_dir=default --hidden_units=50 --u_hidden_units=50 --maxlen=${maxlen} --dropout_rate=${dropout} --model=${model} --num_epochs=${epoch} --c0=0 --disentangle=False --debias=True --additive_bias=True > logs_ipw/${dataset}_${model}_biastower_$i.log  2>&1 &
