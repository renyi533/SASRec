...
do
    ...
    for config in ml-1m,200,0.2,200,30,25 Video,50,0.5,200,70,25 Steam,50,0.5,100,30,6 Electronics,50,0.5,100,70,6 
    do
        IFS=',' read dataset maxlen dropout epoch c0 u_hidden_units <<< "${config}"
